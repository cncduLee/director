 ...
 * {@link Director#begin(EventHandler...)},
 * {@link Director#after(EventHandler...)} and
 * {@link EventHandlerGroup#then(EventHandler...)}. After the transaction is
 * ready by called {@link Director#ready()}, We can publish event synchronously
 * by {@link Director#publish(Object)} or asynchronously by
 * {@link Director#publish(Object, Callback)} to invoke a transaction.
 * 
...
public class Director<Event> {
	 ...
	 */
	public Director(ExecutorService executorService) {
	 ...
	 *             yet.
	 * 
	 * @see Director#after(EventHandler...)
	 ...
	 * 
	 * @see EventHandlerGroup#then(EventHandler...)
	 * @see Director#begin(EventHandler...)
	 */
	 ...
	 *         ready by call {@link Director#ready()}.
	 */
